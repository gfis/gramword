 ...
 *  @(#) $Id: GrammarHandler.java 36 2008-09-08 06:05:06Z gfis $
 *  2016-09-19: old package name was gramword/filters
 *  2008-04-01: style.js incorporated
 *  2007-02-21: general parts extracted to BaseHandler
...
import  org.teherba.gramword.handler.BaseHandler;
 ...
 */
public class GrammarHandler extends BaseHandler { 
    public final static String CVSID = "@(#) $Id: GrammarHandler.java 36 2008-09-08 06:05:06Z gfis $";
    ...
    public GrammarHandler() {
        super();
        log = Logger.getLogger(GrammarHandler.class.getName());
    } // constructor
    ...
    private void putHeader(PrintWriter writer, String mode, String title) { 
        ...
        try {
            if (false) {
                ...
                writer.println("<head>");
                writer.println("<!-- automatically generated by GrammarHandler.java - do not edit here! -->");
    ...
    /** Creates a handler, gets all options from the commandline
     *  and processes the input file accordingly
     *  @param args commandline arguments (see <em>BaseHandler.getOptions</em>)
     */
    public static void main(String args[]) {
        GrammarHandler handler = new GrammarHandler();
        handler.getOptions(args);
